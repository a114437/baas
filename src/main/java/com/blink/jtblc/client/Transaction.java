...
//				 tx_json.put("MemoData", __stringToHex(utf8.encode(memo));
				List<Map<String, Map<String, Object>>> memoList = new ArrayList<Map<String, Map<String, Object>>>();
				Map<String, Object> memoDataMap = new HashMap<String, Object>();
				memoDataMap.put("MemoData", bytesToHexString(memo.getBytes()));
				Map<String, Map<String, Object>> memoMap = new HashMap<String, Map<String,Object>>();
				memoMap.put("Memo", memoDataMap);
				memoList.add(memoMap);
				txJson.put("Memos", memoList);
			}
		}
//		params.put("memo", this.memo);
		params.put("command", this.command);
