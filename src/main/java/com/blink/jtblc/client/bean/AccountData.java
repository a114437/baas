...
//    private Integer transferRate;
	...
	public String toString() {
		return "AccountData [account=" + account + ", balance=" + balance + ", flags=" + flags + ", ownerCount="
				+ ownerCount + ", previousTxnId=" + previousTxnId + ", previousTxnLgrSeq=" + previousTxnLgrSeq
				+ ", sequence=" + sequence + ", index=" + index + ", ledgerEntryType=" + ledgerEntryType + "]";
	}
