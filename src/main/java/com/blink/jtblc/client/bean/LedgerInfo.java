...
public class LedgerInfo {
	...
	public String toString() {
		return "LedgerInfo [feeBase=" + feeBase + ", feeRef=" + feeRef + ", hostid=" + hostid + ", ledgerHash="
				+ ledgerHash + ", ledgerIndex=" + ledgerIndex + ", ledgerTime=" + ledgerTime + ", pubkeyNode="
				+ pubkeyNode + ", reserveBase=" + reserveBase + ", reserveInc=" + reserveInc + ", serverStatus="
				+ serverStatus + ", validatedLedgers=" + validatedLedgers + ", lines=" + lines + "]";
	}
}
