...
public class Md5 {
	...
	public static String key = "DDYQ4Is5IjU3NwU3NyxCQg==";
	public static void main(String[] args) throws Exception {
//		String encrypt = encrypt("哈哈哈哈");
//		System.out.println(encrypt);
//		String decrypt = decrypt("6QA/RqOU/pVcoL6ZK3sIRjwT0LbogBdw");
//		System.out.println(decrypt);
		String encrypt = Md5.encrypt("1");
		System.out.println(encrypt);
		//eaI/BsJyy55w7A/0Oc7zFuNcujrJ/ErgttVxz0peCtwSCdxrAuqOW1X7U0DIakk3m8SvVNygUBgu
		//eaI/BsJyy55w7A/0Oc7zFuNcujrJ/ErgttVxz0peCtwSCdxrAuqOW1X7U0DIakk3m8SvVNygUBgu
		String decrypt = Md5.decrypt("EDpSSdgv0W3uxvxdxEAdPlV5y6WoNRfsTi2/dpGuIJ9aLKrkcbFshp8NDtodcEyZIGDte4JX8Byq\r\n" + 
				"ypWMGDAZn1G/J6KC30TXwJUPE6y7eCI93RMN9AmICQ==");
		System.out.println(decrypt);
		
//		byte[] s = {12,54,16,-32,-117,57,34,53,55,55,5,55,55,44,66,66};
...
//		System.out.println(encode);
	...
	public static String encrypt(String xmlStr) {
		...
		byte[] md5Hasn = null;
		try {
			md5Hasn = Md5.MD5Hash(encrypt, 0, encrypt.length);
		} catch (Exception e) {
			e.printStackTrace();
		}
		// 组合消息体
		byte[] totalByte = Md5.addMD5(md5Hasn, encrypt);

		// 取密钥和偏转向量
		byte[] key = new byte[8];
		byte[] iv = new byte[8];
		getKeyIV(Md5.key, key, iv);
		...
		byte[] temp = null;
		try {
			temp = Md5.DES_CBC_Encrypt(totalByte, deskey, ivParam);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static String decrypt(String xmlStr) throws Exception {
		...
		byte[] temp = null;
		try {
			temp = Md5.DES_CBC_Decrypt(encBuf, deskey, ivParam);
		} catch (Exception e) {
			e.printStackTrace();
		}
