...
public class Subchain{
	...
	@Column(name="vss_base_code",columnDefinition="longtext")
	@ApiModelProperty(value="vss合约编码",name="vssBaseCode")
	private String vssBaseCode;

	@Column(name="vss_base_hash",length=200)
	@ApiModelProperty(value="vss合约部署hash",name="vssBaseHash")
	private String vssBaseHash;

	@Column(name="vss_base_threshold",length=10)
	@ApiModelProperty(value="子链scs节点的三分之二个数",name="vssBaseThreshold")
	private String vssBaseThreshold;

	@Column(name="vss_base_address",length=200)
	@ApiModelProperty(value="vss合约地址",name="vssBaseAddress")
	private String vssBaseAddress;
	...
	public String getVssBaseCode() {
		return vssBaseCode;
	}

	public void setVssBaseCode(String vssBaseCode) {
		this.vssBaseCode = vssBaseCode;
	}

	public String getVssBaseHash() {
		return vssBaseHash;
	}

	public void setVssBaseHash(String vssBaseHash) {
		this.vssBaseHash = vssBaseHash;
	}

	public String getVssBaseThreshold() {
		return vssBaseThreshold;
	}

	public void setVssBaseThreshold(String vssBaseThreshold) {
		this.vssBaseThreshold = vssBaseThreshold;
	}

	public String getVssBaseAddress() {
		return vssBaseAddress;
	}

	public void setVssBaseAddress(String vssBaseAddress) {
		this.vssBaseAddress = vssBaseAddress;
	}
}
